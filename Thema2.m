...
for i = 1:length(l_array)
    ...
    [num_calls_f1, a_values_f1, b_values_f1] = XrysosTomeas(f1, a, b, l, g);
    num_calc_f1(i) = num_calls_f1;

    [num_calls_f2, a_values_f2, b_values_f2] = XrysosTomeas(f2, a, b, l, g);

    num_calc_f2(i) = num_calls_f2;

    [num_calls_f3, a_values_f3, b_values_f3] = XrysosTomeas(f3, a, b, l, g);
...
% Τα διαγράμματα βγαίνουν ίδια. Όσο μικρότερο είναι το l, χρειαζόμαστε
% περισσότερες επαναλήψεις για να συρρικνωθεί το διάστημα [a,b] επαρκώς.
figure(1);
